...
const EditHowtoOption = () => {
  ...
  const handleEdit = (event) => {
    ...
    fetch(url, {
      ...
      .then((res) => res.json())
      .then((result) => {
        navigate("/admin/how-to-option/");
      });
  };

  useEffect(() => {
    fetch(`http://localhost:5000/help-section/${id}`)
      .then((res) => res.json())
      .then((info) => {
          ...
          <div className="row justify-center">
            <div className="col-12">
              <div className="heading-section  fadeInUp style-2 text-center">
                <div className="main-title">Edit Option</div>
              </div>
            </div>
            <div className="col-12">
...
export default EditHowtoOption;
