...
const EditWhyChooseTitle = () => {
  ...
  const handleEditTitle = async (event) => {
    ...
    const url = `http://localhost:5000/edit-why-choose-title/${id}`;
    fetch(url, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    fetch(`http://localhost:5000/why-choose-title/${id}`)
      .then((res) => res.json())
      .then((info) => {
          ...
          <div className="row justify-center">
            <div className="col-12">
              <div className="heading-section  fadeInUp style-2 text-center">
                <div className="main-title">Edit Why Choose Title</div>
              </div>
            </div>
            <div className="col-12">
...
export default EditWhyChooseTitle;
